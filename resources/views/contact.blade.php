    ...
    <div class="row justify-content-center space">
        ...
        <div class="col-md-8 wow bounceIn">
            @if(Session::has('success'))
             ...
             @endif 
            <p class="text-center" style="font-size:29px; font-weight:bold;">GET IN TOUCH WITH US</p>
        <div class="card" style="background:goldenrod; border:2px solid goldenrod; ">
            ...
            <div class="card-body" >
               <form action="{{ url('contact') }}" id="form" method="POST">
                  ...
                  <p><input type="tel" name="phone" placeholder="Phone number" class="form-control"></p>
                  <p><textarea name="message" cols="40" rows="10"  aria-invalid="false" placeholder="Your Message"></textarea></p>
                  <p><input type="submit" class="button button-simple btn-submit mt-30" value="SEND"></p>
