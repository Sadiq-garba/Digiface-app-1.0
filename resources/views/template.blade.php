...
<body>
  ...
  <header id="header">
    <div class="container d-flex">
      ...
      <div class="mr-auto">
        <h1 class="text-light"><a href="index.html"><img src="assets/img/trans_logo.png" width="40" height="40"></a></h1>
        ...
        <div class="carousel-inner" role="listbox">
          ...
          <div class="carousel-item " style="background: url(assets/img/slide/slide-1.jpg)">
            <div class="carousel-container">
              ...
              <h2 class="animated fadeInDown"><span> Welcome to golden web solutions</span></h2>
                <p class="animated fadeInUp">welcome to golden web solutions</p>
                <a href="" class="btn-get-started animated fadeInUp">Sign Up</a>
              </div>
            </div>
          </div>
        ...
        <div class="row">
          <div class="col-lg-4">
            <div class="icon-box">
              ...
              <p>You don't need to break the bank to give your business an online presence. Setup a one page website with us for free</p>
            </div>
          </div>
      ...
      <div class="container">
        ...
        <div class="row">
          ...
          <div class="col-lg-6 pt-4 pt-lg-0 content">
            ...
            <p>
               Golden web solution is a young company created with the objective of providing a platform where startups and freelancers can get their products or services an online presence for free 
            </p>
          </div>
        </div>
 ...
 <!--   <div class="footer-newsletter">
    ...
    <div class="container">
      <div class="copyright">
        &copy; Copyright <strong><span>Golden web solutions</span></strong>. All Rights Reserved
      </div>
      <div class="credits">
        ...
        Powered by <a href="https://bootstrapmade.com/">Golden web solutions</a>
      </div>
    </div>
  </footer><!-- End Footer -->
